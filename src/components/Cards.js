  ...
  return (
    ...
    <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
        <div className='w-full shadow-xl border border-t-0 border-gray-200 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
            ...
            <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 uppercase'>Start Trial</button>
        </div>
        <div className='w-full shadow-xl border border-t-0 border-gray-200 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
            ...
            <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 uppercase'>Start Trial</button>
        </div>
        <div className='w-full shadow-xl border border-t-0 border-gray-200 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
